  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-12 px-6 max-w-4xl mx-auto">
        <h3 className="text-xl font-bold text-center text-gray-800 mb-8">Para qué nivel buscas?</h3>
      ...
      <section className="bg-gray-50 py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-xl font-bold text-center text-gray-800 mb-8">Como funciona?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Responde el examen generado automaticamente</p>
            </div>
          </div>
        </div>
      </section>
