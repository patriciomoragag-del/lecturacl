...
export default function AuthPage() {
  ...
  const handleAuth = async () => {
    ...
    if (isLogin) {
      ...
      else setMensaje('¡Bienvenido! Iniciaste sesión correctamente.')
    } else {
    ...
    <main className="min-h-screen bg-blue-600 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mt-2">LecturaCL</h1>
        ...
        <div className="space-y-4">
          ...
          >
            {cargando ? 'Cargando...' : isLogin ? 'Iniciar sesión' : 'Crear cuenta'}
          </button>
